...
const Navbar = () => {
  ...
  return (
    <nav className={navbarClasses}>
      {/* Top Banner */}
      <div className="bg-brand-gold text-brand-navy text-xs py-2 hidden md:block">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center font-bold">
          <div className="flex space-x-6 items-center">
            <span className="flex items-center space-x-1">
              <span>📍</span> <span>Nakuru / Eldoret, Kenya</span>
            </span>
            <span className="flex items-center space-x-1">
              <span>📞</span> <span>+254 758 094 985 / +254 113 713 285</span>
            </span>
            <span className="flex items-center space-x-1">
